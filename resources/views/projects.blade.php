    ...
    <div class="px-2 md:px-8 py-6 pb-12 h-[92vh] overflow-y-auto">
        ...
        <x-mainPageTitle :title="__('Projects')">
            <div class="flex items-center space-x-3">
                ...
                <div class="px-3 py-1 bg-blue-700 text-white rounded-md font-bold cursor-pointer openModal">Create
                    Project</div>
            </div>
        </x-mainPageTitle>
        {{-- Page Content  --}}
                ...
                <div class="flex items-center justify-between px-6 py-3 border-b">
                    <a href="#">
                        <div class="flex items-center">
                            <div class="w-2.5 h-2.5 bg-{{ $project->color }}-500 rounded-full"></div>
            ...
            <div class="base">
                <div class="inner">
                    <div class="px-6 pt-6 w-[650px]">
                        ...
                        <div class="pt-2 ml-2">
                            ...
                            <div class="flex gap-1 mt-1 pb-6">
                                @foreach (['red', 'orange', 'gray', 'green', 'yellow', 'pink', 'purple', 'sky', 'teal', 'cyan', 'rose'] as $color)
                                    <label class="w-6 h-6 rounded-md cursor-pointer bg-{{ $color }}-500">
                    ...
                    <div class="bg-slate-300/20 py-5 px-6 flex items-center justify-end space-x-2">
                        ...
                        <div class="px-3 py-1 bg-blue-700 text-white rounded-md font-bold cursor-pointer openModal">
                            Create Project</div>
                    </div>
                </div>
            </div>
